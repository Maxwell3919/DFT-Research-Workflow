...
def main() -> None:
    ...
    report = {
        ...
        "evidence_boundary": (
            ...
            "reference-state metadata, energy-ledger arithmetic, synthetic EOS, defect, surface, adsorption, Fermi-isovalue, charge-difference closure, potential-lineup, COHP-window, magnetic-candidate, magnetic-anisotropy/exchange-ledger, elastic strain--stress-ledger, Born-charge/dielectric-ledger, polarization-branch, piezoelectric-ledger, anharmonic-linewidth-ledger, lattice-transport-tensor-ledger, EPC-channel-ledger, superconductivity-spectral-moment-ledger, reaction-path-barrier-ledger, diffusion-network-ledger, AIMD-segment-ledger, structural-sampling-overlap, optical-spectrum-comparison, time-dependent-response, and quasiparticle-comparison metadata analysis; actual bounded Silicon QE 7.5 SCF plus Gamma-point DFPT output reconstruction; and frozen public-data convex-hull, Si-surface, CMR adsorption, and CoSb3 transport redraws only; "
            ...
            "candidate completeness, phonon-frequency convergence, phonon dispersion or stability, transferability, a dielectric response, GW result, or a scientific conclusion."
        ),
    }
    ...
    print(
        f"Practical guide execution passed: {len(results)}/{len(SCRIPTS)} examples; four structural transformations, "
