...
if ! rg -Fq "$case_dir" "$case_dir/output/chromium.stderr"; then pass 'G0 public stderr contains no runtime case path'; else fail 'G0 public stderr contains a runtime case path'; fi
