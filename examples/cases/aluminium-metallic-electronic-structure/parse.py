...
def main() -> None:
    ...
    plt.close(histogram)
    artifacts = [artifact("SCF input", "input/scf.in"), artifact("NSCF input", "input/nscf.in"), artifact("bands input", "input/bands.in"), artifact("real dos.x input", "input/dos.in"), artifact("exploratory convergence plan", "input/convergence-matrix-plan.json"), artifact("convergence input generator", "input/generate_convergence_inputs.py"), artifact("convergence assessor", "input/parse_convergence.py"), artifact("direct external convergence runner", "input/run-convergence-matrix.sh"), artifact("bounded E(V) plan", "input/eos-plan.json"), artifact("E(V) input generator", "input/generate_eos_inputs.py"), artifact("E(V) assessor", "input/parse_eos.py"), artifact("direct external E(V) runner", "input/run-eos.sh"), artifact("initial captured SCF stdout", "output/scf.out"), artifact("initial captured NSCF stdout", "output/nscf-full.out"), artifact("initial captured bands stdout", "output/bands.out"), artifact("rerun SCF stdout", "output/dos-route/scf.out"), artifact("rerun SCF stderr", "output/dos-route/scf.err"), artifact("rerun NSCF stdout", "output/dos-route/nscf-full.out"), artifact("rerun NSCF stderr", "output/dos-route/nscf-full.err"), artifact("rerun dos.x stdout", "output/dos-route/dos.out"), artifact("rerun dos.x stderr", "output/dos-route/dos.err"), artifact("real QE dos.x table", "output/dos-route/al.dos"), artifact("rerun bands stdout", "output/dos-route/bands.out"), artifact("rerun bands stderr", "output/dos-route/bands.err"), artifact("raw-derived mesh table", "derived/al-mesh.csv"), artifact("raw-derived path table", "derived/al-path.csv"), artifact("Gaussian raw-NSCF representation", "derived/al-dos-gaussian.csv"), artifact("Gaussian representation metadata", "derived/al-dos-gaussian-metadata.json"), artifact("real dos.x parsed table", "derived/al-dos-x.csv"), artifact("real dos.x metadata", "derived/al-dos-x-metadata.json"), artifact("case summary", "derived/captured-run-summary.json"), artifact("raw NSCF sampling histogram", "figures/raw-nscf-band2-sampling.png"), artifact("Gaussian DOS-like plot", "figures/al-dos-gaussian.png"), artifact("real dos.x plot", "figures/al-dos-x.png")]
    for route, ids in (("convergence-screen", ["al-k08-d002", "al-k10-d002", "al-k12-d002", "al-k12-d001", "al-k12-d004"]), ("eos-screen", ["al-eos-a7450", "al-eos-a7550", "al-eos-a7653", "al-eos-a7750", "al-eos-a7850"])):
        for identifier in ids:
