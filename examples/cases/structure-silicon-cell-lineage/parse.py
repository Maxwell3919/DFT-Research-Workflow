...
def main():
 ...
 a=read(SRC); write(OUT/'silicon-conventional.xyz',a); write(OUT/'POSCAR.conventional',a,format='vasp',direct=True,vasp5=True)
 ...
 write(OUT/'silicon-primitive.xyz',prim); write(OUT/'POSCAR.primitive',prim,format='vasp',direct=True,vasp5=True); write(OUT/'silicon-standardized-conventional.xyz',conv)
 sc=prim.repeat((2,2,2)); write(OUT/'silicon-primitive-2x2x2.xyz',sc); write(INP/'POSCAR.silicon-primitive',prim,format='vasp',direct=True,vasp5=True)
