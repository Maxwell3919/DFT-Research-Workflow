...
const routes = [
  ['/operations/elastic-constants-and-mechanical-properties/', 'Elastic Constants and Mechanical Properties', 'The elastic tensor is an energy curvature with declared variables'],
  ['/operations/elastic-constants-and-mechanical-properties/guides/check-strain-stress-ledger/', 'Check a Strain--Stress Ledger', 'Execution verifies invented ledger arithmetic, an explicit units label'],
];
try {
  ...
  console.log('Reviewed elastic-constants smoke passed: topic and guide, original media, 1440px/390px no-overflow, and no-JavaScript reading.');
