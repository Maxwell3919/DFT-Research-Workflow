...
const guides = [
  {
    ...
    listed: true,
    mediaCount: 0,
    tool: 'Atomic Simulation Environment',
    version: 'ASE 3.29.0',
  ...
  },
  {
    ...
    tool: 'Atomic Simulation Environment',
    version: 'ASE 3.29.0',
    phrase: 'A restart is a continuation of a traceable interrupted optimization problem',
    boundary: 'It does not execute a restart',
  },
  {
