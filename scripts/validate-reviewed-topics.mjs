...
const reviewedTopicSpecifications = {
  ...
  'relative-and-formation-energies': {
    ...
    boundaries: [
      ...
      'It does not establish the global structural or electronic ground state, an exhaustive competing-phase set, a reaction pathway or rate, finite-temperature equilibrium without the required terms, synthesizability, or agreement with experiment.',
    ],
    sources: [
  ...
  'equation-of-state-and-structural-phase-stability': {
    ...
    boundaries: [
      'The result does not establish full elastic or dynamical stability, cross-composition stability, a pathway or rate, finite-temperature equilibrium without required terms, or experimental phase identity.',
