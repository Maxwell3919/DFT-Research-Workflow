...
async function inspect(page, guide, width) {
  ...
  if (!result.meta || !result.evidence || result.images.length !== 1 || !result.images[0].alt || !result.images[0].loaded) throw new Error(`${guide.route}: metadata, evidence, or real-data media missing`);
