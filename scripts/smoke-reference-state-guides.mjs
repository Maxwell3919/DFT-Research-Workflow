...
const guides = [
  ...
  },
  {
    ...
    tool: 'Python',
    version: 'Python 3.12',
    phrase: 'An interrupted-run restart and a file-initialized new SCF are different operations.',
    boundary: 'does not verify input compatibility, restart data, or electronic-state identity',
    mediaCount: 0,
  },
  {
