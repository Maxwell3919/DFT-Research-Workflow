...
const guides = [
  ...
  { route: `${parentRoute}examples/fit-and-challenge-equation-of-state/`, title: 'Fit and Challenge an Equation of State', phrase: 'Use this fixture after a traceable energy-volume table has passed branch and convergence checks.', tools: ['python', 'atomic simulation environment'], versions: ['Python 3.12', 'ASE 3.29.0'], boundary: 'It does not run DFT, validate the point series, select a universally preferred EOS, calculate a physical equilibrium volume or modulus, establish elastic or phonon stability, or predict a transition.' },
  { route: `${parentRoute}examples/compare-phase-enthalpies-common-pressure/`, title: 'Compare Phase Enthalpies at Common Pressure', phrase: 'Use this fixture after two phase branches have been fitted over a common supported pressure interval.', tools: ['python', 'atomic simulation environment'], versions: ['Python 3.12', 'ASE 3.29.0'], boundary: 'The fixture contains no DFT run, pathway, barrier, nucleation model, phonons, elastic tensor, finite-temperature contribution, or experimental pressure calibration.' },
];
