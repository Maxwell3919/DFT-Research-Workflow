...
const guides = [
  { route: `${parentRoute}guides/design-traceable-energy-volume-series/`, title: 'Design a Traceable Energy–Volume Series', phrase: 'An EOS fit should begin only after its energy–volume points form one comparable structural and electronic branch.', tools: ['python'], versions: ['Python 3.12'], boundary: 'It does not run a DFT code' },
  { route: `${parentRoute}examples/fit-and-challenge-equation-of-state/`, title: 'Fit and Challenge an Equation of State', phrase: 'This worked example generates one invented energy–volume table', tools: ['python', 'ase'], versions: ['Python 3.12', 'ASE 3.29.0'], boundary: 'The example does not run DFT' },
  { route: `${parentRoute}examples/compare-phase-enthalpies-common-pressure/`, title: 'Compare Phase Enthalpies at Common Pressure', phrase: 'This worked example uses two invented analytic branches.', tools: ['python', 'ase'], versions: ['Python 3.12', 'ASE 3.29.0'], boundary: 'The example does not execute DFT' },
];
