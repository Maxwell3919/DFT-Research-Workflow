...
try {
  ...
  if (artifactDirectory) {
    ...
    await page.screenshot({ path: join(artifactDirectory, 'practical-guides-parent-desktop.png'), fullPage: true });
    await page.goto(`${base}${guides[3].route}`, { waitUntil: 'domcontentloaded' });
    await page.screenshot({ path: join(artifactDirectory, 'practical-guide-monolayer-desktop.png'), fullPage: true });
