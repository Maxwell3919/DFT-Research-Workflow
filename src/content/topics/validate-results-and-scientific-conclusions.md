...
## Establish artifact identity before interpreting physics
...
## Test numerical sensitivity at the observable level
...
## Challenge physical consistency
...
## Probe model and method sensitivity
...
## Compare with external evidence on the same observable
...
A fitted datum is calibration, not independent validation. Stronger tests use withheld conditions, independent observables, or systems not used to choose the model. A discrepancy should be separated into numerical uncertainty, model discrepancy, experimental uncertainty, and mismatch of the compared object rather than assigned automatically to either theory or experiment.
...
## Convert the challenges into a decision
